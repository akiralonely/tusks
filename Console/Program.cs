...
class Program
{
    ...
    static void ChooseSortingType(string input)
    {
        ...
        if (sortOption == 1)
        {
            ...
            Console.WriteLine("Сортированная строка: " + sorted);
        }
        ...
        {
            Console.WriteLine("Выбран недопустимый параметр сортировки.");
        }
    ...
    static int GetRandomIndex(int maxLength)
    {
        ...
        using (var client = new HttpClient())
        {
            try
            {
                ...
                {
                    Console.WriteLine("Random.org API недоступен, генерирует локальное случайное число");
